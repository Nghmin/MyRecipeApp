      ...
      <FlatList
        ...
        ListHeaderComponent={
          <>
            {ListHeaderComponent}
            {mode === 'all' && (
              <View style={[styles.header, { marginTop: 10, marginHorizontal: 0, borderColor: currentTheme.primary, borderWidth: 2 }]}>
...
const PostCard = ({ post, onLike, isLiked, onSave, isSaved, onPress, isMine, onDelete, currentTheme }: {
  post: CommunityPost,
  onLike: () => void,
  isLiked: boolean,
  onSave: () => void,
